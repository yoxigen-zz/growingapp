define(["angular", "components/indexeddb", "services/parse"], function(angular){
    "use strict";

    angular.module("DataObject", ["xc.indexedDB", "Parse"]).factory("DataObject", DataObjectClass);

    DataObjectClass.$inject = ["$q"];

    function DataObjectClass($q) {
        /**
         * Prototype for data objects - those that should be saved to local DB (and potentially synced to cloud)
