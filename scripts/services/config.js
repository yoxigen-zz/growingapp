define(["angular", "moment", "services/utils", "services/localization"], function(angular, moment){
    config.$inject = ["utils", "localization"];

    return angular.module("Config", ["Utils", "Localization"]).factory("config", config);

    function config(utils, localization){
        var entries = {
