define(["angular", "modules/insights/insight"], function(angular, Insights){
    'use strict';

    angular.module("Insights").factory("insights", insights);

    insights.$inject = ["entries", "Insight", "dialogs", "entriesModel"];

    function insights(entries, Insight, dialogs, entriesModel){
        var insightsList = [
